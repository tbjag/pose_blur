...
from yolov8.plotting import Annotator, colors, save_one_box
from yolov8.torch_utils import smart_inference_mode
...
class Results(SimpleClass):
    ...
    def tojson(self, normalize=False, decimals=5):
        ...
        print("WARNING ⚠️ 'result.tojson()' is deprecated, replace with 'result.to_json()'.")
